...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1').split(',') + ['.vercel.app', 'kogiuncovered.online', 'www.kogiuncovered.online']

# Application definition
INSTALLED_APPS = [
    # 'django.contrib.admin',  # Removed - using custom admin dashboard
    'django.contrib.auth',
